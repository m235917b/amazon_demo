...
CREATE TABLE `orderposition` (
  ...
  CONSTRAINT `orderposition_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`),
  CONSTRAINT `orderposition_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
-- Dump completed on 2021-06-30 13:16:27
